...
def main():
    setup(
        ...
        packages=['inspectorcell',
                  'orangecontrib',
                  'inspectorcell.entities',
                  'inspectorcell.graphics',
                  'inspectorcell.util',
                  'inspectorcell.viewer',
                  'inspectorcell.viewer.dialog',
                  'orangecontrib.inspectorcell',
                  'orangecontrib.inspectorcell.widgets'],
        package_dir={
