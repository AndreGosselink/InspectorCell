...
from ..events import NewViewProps
...
class PropWindow(qw.QDialog):
    ...
    def accept_view_props(self):
        ...
        self.view_props['crosshair'] = self.show_crosshair.isChecked()

        new_view_props = NewViewProps(self.view_props.copy())
        qc.QCoreApplication.postEvent(self.parent(), new_view_props)
